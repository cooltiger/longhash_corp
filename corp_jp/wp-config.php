...
if( isset($_SERVER['HTTP_X_SAKURA_FORWARDED_FOR']) ) {
	$_SERVER['HTTPS'] = 'on';
	$_ENV['HTTPS'] = 'on';
	$_SERVER['HTTP_HOST'] = 'longhash.co.jp';
	$_SERVER['SERVER_NAME'] = 'longhash.co.jp';
	$_ENV['HTTP_HOST'] = 'longhash.co.jp';
	$_ENV['SERVER_NAME'] = 'longhash.co.jp';
}

define('WP_SITEURL', 'https://longhash.co.jp/'); // WordPressアドレス
define('WP_HOME', 'https://longhash.co.jp/'); // サイトアドレス

// ** MySQL 設定 - こちらの情報はホスティング先から入手してください。 ** //
/** WordPress のためのデータベース名 */
define('DB_NAME', 'longhash_jp');
